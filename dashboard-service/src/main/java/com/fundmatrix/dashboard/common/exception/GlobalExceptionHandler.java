package com.fundmatrix.dashboard.common.exception;
...
public class GlobalExceptionHandler {
    ...
    /** Wrap remote Feign failures so downstream outages surface as the same ApiError shape. */
    ...
    public ResponseEntity<ApiError> handleFeign(FeignException ex, HttpServletRequest req) {
        ...
        String message = status == HttpStatus.NOT_FOUND
                ? "A dependent resource could not be found"
