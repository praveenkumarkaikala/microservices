package com.fundmatrix.dashboard.config;
 ...
 * reuse the exact same hasAuthority mapping instead of needing a parallel trust model, and
 * lets "current user" scoped endpoints (e.g. notification-service's /notifications/unread-count)
 * resolve to the actual dashboard caller.
 */
@Configuration
