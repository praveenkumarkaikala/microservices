package com.fundmatrix.transaction.common.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleFeignNotFound(FeignException.NotFound ex, HttpServletRequest req) {
        return build(HttpStatus.NOT_FOUND, "Referenced remote resource was not found", req);
    }

    @ExceptionHandler(FeignException.class)
    public ResponseEntity<ApiError> handleFeign(FeignException ex, HttpServletRequest req) {
        return build(HttpStatus.UNPROCESSABLE_ENTITY, "Dependent service call failed: " + ex.getMessage(), req);
    }
